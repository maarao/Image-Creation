...
$pathname = 'C:\Users\sti03\rclone\rclone.exe mount gcs:st-' + $user + ' M: --network-mode --vfs-cache-mode minimal --config C:\Users\sti03\rclone.conf --log-file C:\Users\sti03\rclone\log_mount.txt'
...
# Remove from startup
Remove-Item -path 'C:\Users\sti03\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\launch_after.bat'
